    ...
    <form action="./Portfolio.php" method="POST">
        <section class="reginput">
            <section class="regcard">
                ...
                ?>
                <p class="logheader">Edit Profile</p>
                <br>
                <p class="logprompt">Login to edit profile</p>
                ...
                <p class="logprompt">Enter new information</p>
                ...
                <input type="submit" value="Edit Profile" name="editorSubmit" class="registerSubmit">
                
                <span>Don't have a profile?</span>
                <a href="./register.php">Add Profile</a>
            </section>
        </section>
